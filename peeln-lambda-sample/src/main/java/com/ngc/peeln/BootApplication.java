...
public class BootApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        logger.info(sampleService.test() + "\n");
    }

    private void saveCustomers() {
        this.sampleService.save(new Customer("Alice", "Smith"));
        this.sampleService.save(new Customer("Bob", "Smith"));
    }

    private void fetchAllCustomers() {
        logger.info("\n");
        logger.info(">>>>>Customers found with findAll():");
        for (Customer customer : this.sampleService.findAll()) {
    ...
    private void fetchIndividualCustomers() {
        ...
        logger.info(ToStringBuilder.reflectionToString(this.sampleService.findByFirstName("Alice")));
        logger.info("\n");

        logger.info(">>>>>Customers found with findByLastName('Smith'):");
        for (Customer customer : this.sampleService.findByLastName("Smith")) {
            logger.info(ToStringBuilder.reflectionToString(customer));
        }
        logger.info("\n");
    }
